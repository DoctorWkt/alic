...
enum {
  ...
  T_VOID,  T_BOOL,					// 22
  T_INT8,  T_INT16,  T_INT32,  T_INT64,			// 24
  T_UINT8, T_UINT16, T_UINT32, T_UINT64,		// 28
  T_FLT32, T_FLT64,					// 32

  // Other keywords
  T_IF, T_ELSE, T_FALSE, T_FOR,				// 34
  T_TRUE, T_WHILE, T_RETURN, T_NULL,			// 38
  T_TYPE, T_ENUM, T_STRUCT, T_UNION,			// 42
  T_TRY, T_CATCH, T_THROWS, T_ABORT,			// 46

  // Structural tokens
  T_NUMLIT, T_STRLIT, T_SEMI, T_IDENT,			// 50
  T_LBRACE, T_RBRACE, T_LPAREN, T_RPAREN,		// 54
  T_COMMA, T_ELLIPSIS, T_DOT,				// 58
};
