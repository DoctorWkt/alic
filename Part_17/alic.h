...
enum {
  ...
  // Structural tokens
  T_NUMLIT, T_STRLIT, T_SEMI, T_IDENT,			// 70
  T_LBRACE, T_RBRACE, T_LPAREN, T_RPAREN,		// 74
  T_COMMA, T_ELLIPSIS, T_DOT,				// 78
  T_LBRACKET, T_RBRACKET, T_COLON			// 81
};
...
enum {
  ...
  A_AAITERSTART, A_AANEXT, A_FUNCITER				// 58
};
