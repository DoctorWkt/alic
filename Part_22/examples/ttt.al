...
bool is_win(int8 ch) {
  ...
  // This foreach loop from low to high, inclusive.
  foreach i (0 ... sizeof(Win) - 1) {
...
public void main(void) {
  ...
  while (true) {
    ...
    // Still going. Choose position 5
    // or a random position if position 5
    // is not available
