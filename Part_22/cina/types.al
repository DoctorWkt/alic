...
Type tystr_void =
  { TY_VOID, 1, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_bool =
  { TY_BOOL, 1, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };

Type tystr_int8 =
  { TY_INT8, 1, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_int16 =
  { TY_INT16, 2, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_int32 =
  { TY_INT32, 4, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_int64 =
  { TY_INT64, 8, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };

Type tystr_uint8 =
  { TY_INT8, 1, true, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_uint16 =
  { TY_INT16, 2, true, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_uint32 =
  { TY_INT32, 4, true, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_uint64 =
  { TY_INT64, 8, true, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };

Type tystr_flt32 =
  { TY_FLT32, 4, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_flt64 =
  { TY_FLT64, 8, false, 0, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };

// voidptr used by NULL
Type tystr_voidptr =
  { TY_VOID, 8, false, 1, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
Type tystr_string =
  { TY_STRING, 8, false, 1, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, false, NULL };
...
public Type *new_type(const int kind, const int size, const bool is_unsigned,
		      const int ptr_depth, string name, const Type * base) {
  Type *ty = NULL;
  Type *walktype;
  bool newnode = false;
...
// does not exist
public Type *find_type(string typename, const int kind,
		       const bool is_unsigned, const int ptr_depth) {
  Type *this;
  ...
  if (typename != NULL) {
    ...
    // Don't look at any types with names
    foreach this(Typehead, this.next) {
      if (this.name == NULL && this.kind == kind &&
          this.is_unsigned == is_unsigned && this.ptr_depth == ptr_depth)
	return (this);
    }
  }
...
void add_type(const ASTnode * node) {
  ASTnode *newnode;
...
Type *get_funcptr_type(const Sym * sym) {
  Type *this;
  Sym *psym;
  Paramtype *ptype;
  bool params_match;
  ...
  foreach this (Typehead, this.next) {
    ...
    if (this.excepttype != NULL) {
      if (sym.exceptvar == NULL || sym.exceptvar.ty != this.excepttype)
       continue;
    }
