...
static ASTnode *unsigned_expression(void);
...
static ASTnode *unsigned_expression(void) {
  ...
  if (ty == ty_int8) e->type= ty_uint8;
  if (ty == ty_int16) e->type= ty_uint16;
  if (ty == ty_int32) e->type= ty_uint32;
  if (ty == ty_int64) e->type= ty_uint64;
  return(e);
}
