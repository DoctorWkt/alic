...
Type tystr_void = { TY_VOID, 1 };
Type tystr_bool = { TY_BOOL, 1 };
Type tystr_int8 = { TY_INT8, 1 };
Type tystr_int16 = { TY_INT16, 2 };
Type tystr_int32 = { TY_INT32, 4 };
Type tystr_int64 = { TY_INT64, 8 };
Type tystr_uint8 = { TY_INT8, 1, true };
Type tystr_uint16 = { TY_INT16, 2, true };
Type tystr_uint32 = { TY_INT32, 4, true };
Type tystr_uint64 = { TY_INT64, 8, true };
Type tystr_flt32 = { TY_FLT32, 4 };
Type tystr_flt64 = { TY_FLT64, 8 };
Type tystr_voidptr = { TY_VOID, PTR_SIZE, false, 1 };	// Used by NULL
Type tystr_string  = { TY_STRING, PTR_SIZE, false, 1 };

Type *ty_void = &tystr_void;
Type *ty_bool = &tystr_bool;

Type *ty_int8 = &tystr_int8;
Type *ty_int16 = &tystr_int16;
Type *ty_int32 = &tystr_int32;
Type *ty_int64 = &tystr_int64;

Type *ty_uint8 = &tystr_uint8;
Type *ty_uint16 = &tystr_uint16;
Type *ty_uint32 = &tystr_uint32;
Type *ty_uint64 = &tystr_uint64;

Type *ty_flt32 = &tystr_flt32;
Type *ty_flt64 = &tystr_flt64;

Type *ty_voidptr = &tystr_voidptr;
Type *ty_string  = &tystr_string;
...
Type *find_type(char *typename, int kind, bool is_unsigned, int ptr_depth) {
  ...
  if (typename != NULL) {
    ...
    // Otherwise, search for the type kind. Don't look at
    // any types with names
    for (this = Typehead; this != NULL; this = this->next) {
...
Type *pointer_to(Type * ty) {
  ...
  return (new_type(ty->kind, ty_voidptr->size, ty->is_unsigned,
  ...
  if (is_pointer(ty) && is_integer(node->type)) {
    ...
    switch(op) {
      ...
      case A_SUBTRACT:
        ...
        // Widen the node to be PTR_TYPE
        newnode = widen_type(node, PTR_TYPE, 0);
	if (newnode == NULL)
	  fatal("Could not widen %s to be PTR_TYPE\n",
